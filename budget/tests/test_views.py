...
class TestViews(TestCase):
    ...
    def test_project_detail_POST_adds_new_expense(self):
        ...
        self.assertEqual(
            self.project1.expenses.first().title, 'expense')
    ...
    def test_project_detail_POST(self):
        ...
        first_catergory = Category.objects.get(id=1)
        self.assertEqual(first_catergory.project, project2)
        self.assertEqual(first_catergory.name, "design")
        seconde_catergory = Category.objects.get(id=2)
        self.assertEqual(seconde_catergory.project, project2)
        self.assertEqual(seconde_catergory.name, "development")
